module.exports.testData = [
        ...
        stepDefinitions: {
          ...
          then: [
            ...
            },
            {
              ...
              pre: 'So I can see the text',
              mid: 'in the textbox:',
              values: ['Test Results', 'testreport'],
            },
          ],
          example: [],
        },
        ...
        stepDefinitions: {
          ...
          example: [
            ...
            },
            {
              ...
              pre: '',
              mid: '',
              values: ['AdorableHamster', 'cutehamsterlikesnuts2000', 'https://github.com/sessions/verified-device'],
            },
            {
              id: 3,
              stepType: 'example',
              ...
              pre: '',
              mid: '',
              values: ['NormalHamster', 'FatHamster123', 'https://github.com/sessions/verified-device'],
            },
            {
              id: 2,
              stepType: 'example',
              ...
              pre: '',
              mid: '',
              values: ['OldHamster', 'UglyHamster123', 'https://github.com/sessions/verified-device'],
            },
          ],
        },
  ...
  },
  {
    ...
    background: {
      stepDefinitions: {
        ...
        pre: 'I click the button:',
        mid: '',
        values: ['TODO: Create Scenario as Background'],
        }],
      },
    },
    scenarios: [
        ...
        stepDefinitions: {
          ...
          when: [
            ...
            },
            {
              ...
              pre: 'I click the button:',
              mid: '',
              values: ['TODO: ID of "Unlock-Button"'],
            },
            {
              id: 4,
              stepType: 'when',
              ...
              pre: 'I click the button:',
              mid: '',
              values: ['...'], // TODO: ID of Trash Botton
            },
          ],
          then: [
            {
          ...
          then: [
            {
              ...
              pre: 'So I can see the text',
              mid: 'in the textbox:',
              values: ['Scenario_Id does not exist', 'Scenario not found'], // TODO: StepType: So I can´t see the Text: "insert Text here".
            },
          ],
          example: [],
        },
        ...
        stepDefinitions: {
          ...
          when: [
            ...
            },
            {
              ...
              pre: 'I insert',
              mid: 'into the field',
              values: ['Scenario Creation2', 'ScenarioName'],
            },
            {
              id: 6,
              stepType: 'when',
          ...
          then: [
            {
              ...
              pre: 'So I can see the text',
              mid: 'in the textbox:',
              values: ['Scenario Creation2', 'storyTitle'],
            },
          ],
          example: [],
        },
  ...
  { // Alpha Testing: Scenario Creation and Delete will use this Story!
    story_id: 453406841,
    background: { stepDefinitions: { when: [] } },
    scenarios: [{
      scenario_id: 1,
      name: 'New Scenario',
      stepDefinitions: {
