...
function getScenarioContent(scenarios, storyID) {
	...
	for (const scenario of scenarios) {
		...
		if ((scenario.stepDefinitions.example || scenario.multipleScenario).length > 0) data += `Scenario Outline: ${scenario.name}\n\n`;
		...
		if ((scenario.stepDefinitions.example || scenario.multipleScenario).length > 0) data += `${getExamples(scenario.stepDefinitions.example || scenario.multipleScenario)}\n\n`;
