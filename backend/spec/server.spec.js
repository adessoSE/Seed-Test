...
describe('Server', () => {
  ...
  describe('GET /api/stepTypes', () => {
    it('returns status code 200', (done) => {
      const result = [{
        _id: '5dce728851e70f2894a170b4', id: '', stepType: 'when', type: 'HoverOverAndSelect', pre: 'I hover over the element', mid: 'and select the option', values: ['', ''],
      }, {
      ...
      request.get(`${base_url}/stepTypes`, (error, response, body) => {
        expect(response.statusCode).toBe(200);
