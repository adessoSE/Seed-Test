...
describe('ApiService', () => {
  ...
  describe('getStepTypes', () => {
    it('should get StepTypes', () => {
      const dummySteps: StepType[] = [{'_id': '5d765314aea0c94708a6e0a1', 'id': 0,
...
describe('addScenario', () => {
  it('should add a Scenario', () => {
    const storyID = 5;
    const newScenario: Scenario = {'name': 'New Scenario', 'comment': '', 'scenario_id': 2, 'stepDefinitions': {'given': [], 'when': [], 'then': [], 'example': []}};
  ...
  describe('updateBackground', () => {
    it('should update Background', () => {
      const storyID = 5;
      const updatedBackground: Background = {'name': 'TestBackground', 'stepDefinitions': {'when': []}};
  ...
  describe('updateScenario', () => {
    it('should update Scenaro', () => {
      const storyID = 5;
      const updatedScenario: Scenario = {'name': 'New Scenario', 'comment': '', 'scenario_id': 2, 'stepDefinitions': {'given': [], 'when': [], 'then': [], 'example': []}};
      const updatedStory: Story = {'story_id': 5, 'title': 'Gratis Versand', 'body': 'Als Premium Kunde erhalte ich freien Versand, wenn ich 5 B`cher bestelle', 'state': 'open', 'issue_number': 66, 'assignee': 'adessoCucumber', 'assignee_avatar_url': 'https://avatars0.githubusercontent.com/u/50622173?v=4', 'scenarios': [updatedScenario], 'background': {'name': 'New Background', 'stepDefinitions': {'when': []}}};
      const story: Story = {'story_id': 5, 'title': 'Gratis Versand', 'body': 'Als Premium Kunde erhalte ich freien Versand, wenn ich 5 B`cher bestelle', 'state': 'open', 'issue_number': 66, 'assignee': 'adessoCucumber', 'assignee_avatar_url': 'https://avatars0.githubusercontent.com/u/50622173?v=4', 'scenarios': [updatedScenario], 'background': {'name': 'New Background', 'stepDefinitions': {'when': []}}};
  ...
  describe('deleteScenario', () => {
    it('should delete Scenario', () => {
      ...
      const deletedScenario: Scenario = {'name': 'New Scenario', 'comment': '', 'scenario_id': 2, 'stepDefinitions': {'given': [], 'when': [], 'then': [], 'example': []}};
