...
export class ApiService {
  private apiServer: string = 'https://cucumberapp.herokuapp.com/api'; //'http://localhost:8080/api'; //'https://cucumberapp.herokuapp.com/api'; //'http://localhost:8080/api'; // http://localhost:8080/api'; https://cucumberapp.herokuapp.com/api
