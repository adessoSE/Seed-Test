...
describe('constructor', () => {
  it('should call nothing', () => {
    if(component.apiService.urlReceived){
      let spy = spyOn(component, 'loadStepTypes');
...
describe('addStepToScenario', () => {
  ...
  it('should add a given step to the scenario', () => {
    ...
    spyOn(component, 'createNewStep').and.returnValue(obj);
...
//    let scenario : Scenario = {"scenario_id":1,"comment":"","name":"successful Story creation","stepDefinitions":{"given":[{"id":1,"stepType":"given","type":"Role","pre":"As a","mid":"","values":["Guest"],"selection":["Guest","User"]}],"when":[{"id":1,"stepType":"when","type":"Website","pre":"I am on the website:","mid":"","values":["www.cucumber.com"]},{"id":2,"stepType":"when","type":"Button","pre":"I click the button:","mid":"","values":["Create Story"]}],"then":[{"id":2,"stepType":"then","type":"Text","pre":"So I can see the text","mid":"in the textbox:","values":["New Story created","Success"]}],"example":[{"id":1,"stepType":"example","type":"Text","pre":"","mid":"","values":["test2","test2"]}]}};
//    component.selectedScenario = scenario;
//    let valueIndex = 0
//    let cutInput = 'test'
//    let input = '<test>'
//    spyOn(component, 'exampleHeaderChanged').and.returnValue(true);
//    //spyOn(component.exampleChild, 'updateTable');
//    let step: StepType = {"id":5,"mid":"from the drop-down-menue","pre":"I select the option","stepType":"when","type":"Dropdown","values":["","<l>"]};
...
describe('fillExamples', () => {
  let scenario : Scenario = {"scenario_id":1,"comment":"","name":"successful Story creation","stepDefinitions":{"given":[{"id":1,"stepType":"given","type":"Role","pre":"As a","mid":"","values":["Guest"],"selection":["Guest","User"]}],"when":[{"id":1,"stepType":"when","type":"Website","pre":"I am on the website:","mid":"","values":["www.cucumber.com"]},{"id":2,"stepType":"when","type":"Button","pre":"I click the button:","mid":"","values":["Create Story"]}],"then":[{"id":2,"stepType":"then","type":"Text","pre":"So I can see the text","mid":"in the textbox:","values":["New Story created","Success"]}],"example":[{"id":1,"stepType":"example","type":"Text","pre":"","mid":"","values":["test2","test2"]}]}};
  let exampleStep: StepType = {"id":2,"mid":"","pre":"So I will be navigated to the website:","stepType":"example","type":"Website","values":[]};
  it('tables has rows', () => {
    scenario.stepDefinitions.example.push(exampleStep);
    scenario.stepDefinitions.example.push(exampleStep);
    ...
    expect(component.selectedScenario.stepDefinitions.example[0].values.length).toBe(3)
  })

  it('table has no rows', () => {
    scenario.stepDefinitions.example = []
    scenario.stepDefinitions.example.push(exampleStep);
    //scenario.stepDefinitions.example[1] = undefined;
    component.selectedScenario = scenario;
    let step: StepType = {"id":5,"mid":"from the drop-down-menue","pre":"I select the option","stepType":"when","type":"Dropdown","values":["","<l>"]};
    let cutInput = 'test'
    spyOn(component, 'createNewStep').and.returnValue(exampleStep);;
    component.fillExamples(cutInput, step);
    expect(component.createNewStep).toHaveBeenCalledTimes(1);
    expect(component.selectedScenario.stepDefinitions.example[0].values.length).toBe(5)
  })
})
  ...
  describe('scenarioShiftLeft', () => {
    let stories : Story[]= [{"story_id": 123,"background":{"stepDefinitions":{"when":[{"_id":"5dce728851e70f2894a170b0","id":"","stepType":"when","type":"Button","pre":"I click the button:","mid":"","values":[]}]}},"scenarios":[{"scenario_id":1,"comment":"","name":"successful Story creation","stepDefinitions":{"given":[{"id":1,"stepType":"given","type":"Role","pre":"As a","mid":"","values":["<Guest>"],"selection":["Guest","User"]}],"when":[{"id":1,"stepType":"when","type":"Website","pre":"I am on the website:","mid":"","values":["www.cucumber.com"]},{"id":2,"stepType":"when","type":"Button","pre":"I click the button:","mid":"","values":["Create Story"]}],"then":[{"id":2,"stepType":"then","type":"Text","pre":"So I can see the text","mid":"in the textbox:","values":["New Story created","Success"]}],"example":[{"id":6,"mid":"","pre":"","stepType":"example","type":"Add Variable","values":["OldHamster"]}]}},{"scenario_id":3,"name":"failed Story creation","comment":"","stepDefinitions":{"given":[{"id":1,"stepType":"given","type":"Role","pre":"As a","mid":"","values":["Guest"],"selection":["Guest","User"]}],"when":[{"id":1,"stepType":"when","type":"Website","pre":"I am on the website:","mid":"","values":["www.cucumber.com"]},{"id":2,"stepType":"when","type":"Button","pre":"I click the button:","mid":"","values":["Create Story"]}],"then":[{"id":2,"stepType":"then","type":"Text","pre":"So I can see the text","mid":"in the textbox:","values":["Could not create Story","Error"]}],"example":[]}}],"assignee":"cniebergall","assignee_avatar_url":"https://avatars1.githubusercontent.com/u/45001224?v=4","body":"As a user,\r\nI want to be able to create new features\r\nSo I can test features of my project\r\n","issue_number": 7,"state":"open","title":"Story creation"}];
